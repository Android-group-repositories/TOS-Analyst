...
# notice:The subject or object of Requirements must be the privacy policy type3
"""
Type2. This type also includes other requirements related to children beyond the age range, such as "requiring guardian consent", "classifying the app type as" whether it is for children ", and" declaring whether the app is for children "

Type2. Third party sharing/collection: This type of description describes collection and sharing of children's data with third-party partners
"""
prompt1 = '1'
P2_Types_fmt = '''
